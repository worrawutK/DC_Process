...
Module ModuleAppGeneral
    Friend SizeLoGo As Double

#Region "Commomn Define"
    Public CassetteStatus As EquipmentCassetteStatus
    ...
    'Friend CellconTagList As New Dictionary(Of String, CellConObj)
   
    Friend NetVerSion As String = "+ Relaese Ver1.01_170408"
    ...
    Public Sub SaveCatchLog(ByVal message As String, ByVal fnName As String)
        MDIParent1.slMessage.Text = "TryCatch Err Please check log" & Format(Now, " |HH:mm:ss.fff")   '170328 \783 information adddition if Catch Err
