Public Class Authentication
    ...
    Sub PermiisionCheck(ByVal strOPNo As String, ByVal GetUserAuthenGroupByMCType As String, ByVal GL_Group As String, ByVal Procees As String, ByVal MCNo As String, Optional ETC2 As String = "None")
        Ispass = False

        If ETC2 <> "None" AndAlso CheckAutomotiveLot(ETC2) = True Then 'ตรวจสอบ Lot Automotive
